...
CONTROL_TOPIC_NAME = 'lane_guidance_control'
...
class PathPlanner(Node):
    def __init__(self):
        ...
        self.control_subscriber = self.create_subscription(String, CONTROL_TOPIC_NAME, self.control, 10)
        self.paused = False
    ...
    def control(self, msg):
        ...
        if cmd == 'pause':
            ...
            self.paused = False
            self.get_logger().info('defualt resumed')
